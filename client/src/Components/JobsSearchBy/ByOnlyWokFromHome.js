    ...
    return (<>
        ...
        <div className="m-5 searching ">
            ...
            {Data.post.filter((field) => {
                if (User.searchinput === "") {
                    return 0;
                } else if (field.workFromHome === "Yes") {
                ...
                .map(({ CompanyName, _id, workFromHome , field, email, salaryExpected, phoneNo, fullAddress, state, startingYear, minQualifications, minExperienceNeeded, noOfEmpNeeded }) => {
