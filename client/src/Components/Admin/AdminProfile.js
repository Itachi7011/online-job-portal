                    ...
                    <div className="row">
                        <div className="col-12 bg-white p-0 px-3 py-3 mb-3">
                            <div className="d-flex flex-column align-items-center">
                                ...
                                <p className="fw-bold h4 mt-3 mb-5"><span className="font-big" style={{border:"3px solid red", borderRadius:"2em", padding:"0.7em", color:"white", background:"red"}}>{user.adminName}</span></p>
