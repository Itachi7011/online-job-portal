...
export default function DeleteAndBlockEmployees() {
        ...
        <div className="m-5 searching ">
            ...
            {Data.post.filter((field) => {
                if (User.searchinput === "") {
                    ...
                    field.name.toLocaleLowerCase().includes(User.searchinput.toLocaleLowerCase()) ||
                ...
                .map(({ name, _id, field, email,  phoneNo, fullAddress, noOfEmpNeeded }) => {
                    return <div className="card jobSearchCard" key={name}>
                        <div className="card-body jobSearchCard-body">
                            ...
                            <div className="mb-5" style={{
                                ...
                                <form action="/deleteAndBlockEmployees" method="POST">
